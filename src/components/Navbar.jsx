...
function Navbar() {
    return (
        <>
            <nav className="flex flex-row items-center justify-center gap-4 text-xl w-2/3 rounded-xl absolute top-[100px] left-1/2 transform -translate-x-1/2 -translate-y-1/2">
